...
#ifndef AP_BARO_ANALOG_ENABLED
#define AP_BARO_ANALOG_ENABLED AP_BARO_BACKEND_DEFAULT_ENABLED
#endif
...
#define AP_BARO_MS56XX_ENABLED                                                 \
  (AP_BARO_MS5607_ENABLED || AP_BARO_MS5611_ENABLED ||                         \
   AP_BARO_MS5637_ENABLED || AP_BARO_MS5837_ENABLED)
...
#define AP_BARO_DRONECAN_ENABLED                                               \
  (AP_BARO_BACKEND_DEFAULT_ENABLED && HAL_ENABLE_DRONECAN_DRIVERS)
#endif

#ifndef AP_BARO_AUAV_ENABLED
#define AP_BARO_AUAV_ENABLED                                                   \
  AP_BARO_BACKEND_DEFAULT_ENABLED &&AP_AIRSPEED_AUAV_ENABLED
#endif
...
#define AP_BARO_PROBE_EXT_PARAMETER_ENABLED                                    \
  AP_BARO_PROBE_EXTERNAL_I2C_BUSES || AP_BARO_MSP_ENABLED
#endif

#ifndef AP_BARO_1976_STANDARD_ATMOSPHERE_ENABLED
// default to using the extended functions when doing double precision EKF
// (which implies more flash space and faster MCU) this allows for using the
// simple model with the --ekf-single configure option
#define AP_BARO_1976_STANDARD_ATMOSPHERE_ENABLED                               \
  HAL_WITH_EKF_DOUBLE || AP_SIM_ENABLED
#endif
